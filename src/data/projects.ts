...
const projects: Project[] = [
  // === PIC NIC ===
  // Videos
  { id: 'pn-v13', title: '', category: 'Pic Nic', type: 'video', src: `${CLOUD_BASE}/picnic/reel2`, cover: '/images/covers/picnic-reel2.jpg' },
  { id: 'pn-v10', title: '', category: 'Pic Nic', type: 'video', src: `${CLOUD_BASE}/picnic/reel completo da postare`, cover: '/images/covers/picnic-reel_completo_da_postare.jpg' },
  { id: 'pn-v23', title: '', category: 'Pic Nic', type: 'video', src: `${CLOUD_BASE}/picnic/videofuinito`, cover: '/images/covers/picnic-videofuinito.jpg' },
  { id: 'pn-v20', title: '', category: 'Pic Nic', type: 'video', src: `${CLOUD_BASE}/picnic/video picnic 2`, cover: '/images/covers/picnic-video_picnic_2.jpg' },
  { id: 'pn-v2', title: '', category: 'Pic Nic', type: 'video', src: `${CLOUD_BASE}/picnic/Sequenza 01`, cover: '/images/covers/picnic-Sequenza_01.jpg' },
  { id: 'pn-v17', title: '', category: 'Pic Nic', type: 'video', src: `${CLOUD_BASE}/picnic/stiamo cercando talenti veri`, cover: '/images/covers/picnic-stiamo_cercando_talenti_veri.jpg' },
  { id: 'pn-v18', title: '', category: 'Pic Nic', type: 'video', src: `${CLOUD_BASE}/picnic/video 1 maggio`, cover: '/images/covers/picnic-video_1_maggio.jpg' },
  { id: 'pn-v0', title: '', category: 'Pic Nic', type: 'video', src: `${CLOUD_BASE}/video-apertura`, cover: '/images/covers/picnic-video-apertura.jpg' },
  { id: 'pn-v19', title: '', category: 'Pic Nic', type: 'video', src: `${CLOUD_BASE}/picnic/video finito`, cover: '/images/covers/picnic-video_finito.jpg' },
  { id: 'pn-v15', title: '', category: 'Pic Nic', type: 'video', src: `${CLOUD_BASE}/picnic/seedance-1`, cover: '/images/covers/picnic-seedance-1.jpg' },
  { id: 'pn-v16', title: '', category: 'Pic Nic', type: 'video', src: `${CLOUD_BASE}/picnic/seedance-2`, cover: '/images/covers/picnic-seedance-2.jpg' },
  // Photos
